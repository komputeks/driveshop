    ...
    callbacks: {
        jwt: function (_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var loginPayload, res, data, err_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!(account && user)) return [3 /*break*/, 5];
                        ...
                        case 1:
                            _b.trys.push([1, 4, , 5]);
                            return [4 /*yield*/, fetch(process.env.NEXT_PUBLIC_API_BASE_URL, {
                                    method: "POST",
                        ...
                        case 4:
                            err_1 = _b.sent();
                            console.error("GAS login error:", err_1);
                            return [3 /*break*/, 5];
